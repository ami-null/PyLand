...
:: ============================================================
::  Generates relocatable .exe wrappers for all console_scripts
::  entry points found in the portable Python's site-packages.
::
::  Usage: portable-exe-launcher-creator.bat [/nopause]
:: ============================================================

call "%~dp0dependencies\_config.bat"

set "HELPER=%HELPER_SCRIPTS_DIR%\make-portable-exe.py"
